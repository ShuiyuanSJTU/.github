...
python $ROOT_DIR/scripts/generate_plugin_compacity_yml.py $UPSTREAM_DIR/.github/workflows/discourse-plugin.yml $ROOT_DIR/.github/workflows/plugin-compatibility.yml
